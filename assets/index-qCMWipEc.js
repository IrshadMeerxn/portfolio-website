...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X2, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React$2.useState(null), [lt, J2] = React$2.useState(null), [W2, H2] = React$2.useState(false), [A, mt] = React$2.useState(false), [L, z2] = React$2.useState(false), [ct, d] = React$2.useState(false), [h, y] = React$2.useState(false), [R, j] = React$2.useState(0), [p, _2] = React$2.useState(0), O2 = React$2.useRef(t.duration || X2 || Wt), G = React$2.useRef(null), k = React$2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N2 = t.type, V2 = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React$2.useMemo(() => S.findIndex((r2) => r2.toastId === t.id) || 0, [S, t.id]), Jt = React$2.useMemo(() => {
    var r2;
    return (r2 = t.closeButton) != null ? r2 : et;
  }, [t.closeButton, et]), Tt = React$2.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = React$2.useRef(0), U2 = React$2.useRef(0), St = React$2.useRef(0), K = React$2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React$2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N2 === "loading";
  ...
  }, [D, u, t, N2, it, Et, $]), React$2.useEffect(() => {
    t.delete && $();
  }, [$, t.delete]);
  function Zt() {
    var r2, m, c;
    return P != null && P.loading ? React$2.createElement("div", { className: M(s == null ? void 0 : s.loader, (r2 = t == null ? void 0 : t.classNames) == null ? void 0 : r2.loader, "sonner-loader"), "data-visible": N2 === "loading" }, P.loading) : rt ? React$2.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t == null ? void 0 : t.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N2 === "loading" }, rt) : React$2.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t == null ? void 0 : t.classNames) == null ? void 0 : c.loader), visible: N2 === "loading" });
  }
  return React$2.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N2], (Pt = t == null ? void 0 : t.classNames) == null ? void 0 : Pt[N2]), "data-sonner-toast": "", "data-rich-colors": (Nt = t.richColors) != null ? Nt : F, "data-styled": !(t.jsx || t.unstyled || a), "data-mounted": W2, "data-promise": !!t.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L, "data-dismissible": V2, "data-type": N2, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D || B && W2), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U2.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t.style }, onDragEnd: () => {
...
var $e = reactExports.forwardRef(function(e, t) {
  ...
  return React$2.useEffect(() => v.subscribe((d) => {
    ...
    var j;
    let [y, R] = d.split("-");
    return B.length ? React$2.createElement("ol", { key: d, dir: ot === "auto" ? _t() : ot, tabIndex: -1, ref: A, className: g, "data-sonner-toaster": true, "data-theme": W2, "data-y-position": y, "data-lifted": Y && B.length > 1 && !w, "data-x-position": R, style: { "--front-toast-height": `${((j = nt[0]) == null ? void 0 : j.height) || 0}px`, "--width": `${he}px`, "--gap": `${at}px`, ...ut, ...Te(i, D) }, onBlur: (p) => {
...
const About = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-16 sm:py-20 md:py-32 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto px-4", children: "Passionate developer with a love for creating exceptional digital experiences" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 md:order-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl sm:text-2xl font-bold mb-3 sm:mb-4", children: "Hello! I'm Irshad" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 sm:space-y-4 text-muted-foreground text-sm sm:text-base", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I'm a full-stack developer with over 5 years of experience building web applications that users love. My journey in tech started with a curiosity about how things work, and it's evolved into a passion for creating elegant solutions to complex problems." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I specialize in modern web technologies and have a keen eye for design. Whether it's crafting pixel-perfect interfaces or architecting robust backend systems, I bring dedication and creativity to every project." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "When I'm not coding, you'll find me exploring new technologies, contributing to open-source projects, or sharing knowledge with the developer community." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-1 md:order-2 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary to-accent rounded-2xl blur-2xl opacity-30" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6", children: highlights.map((item) => {
      const Icon2 = item.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "border-border/50 hover:border-primary/50 transition-colors",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 sm:pt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-3 sm:mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5 sm:h-6 sm:w-6 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold mb-1.5 sm:mb-2 text-sm sm:text-base", children: item.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground", children: item.description })
          ] })
        },
        item.title
      );
...
const Contact = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-16 sm:py-20 md:py-32 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto px-4", children: "Have a project in mind or just want to chat? I'd love to hear from you!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-6 sm:gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-1 space-y-4 sm:space-y-6", children: contactInfo.map((item) => {
        const Icon2 = item.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 sm:pt-6 p-4 sm:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4 sm:h-5 sm:w-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs sm:text-sm text-muted-foreground mb-1", children: item.label }),
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm sm:text-base", children: item.value })
          ] })
        ] }) }) }, item.label);
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "md:col-span-2 border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-4 sm:p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg sm:text-xl", children: "Send a Message" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-xs sm:text-sm", children: "Fill out the form below and I'll get back to you as soon as possible." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4 sm:p-6 pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "name", className: "text-xs sm:text-sm", children: "Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "name",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "email", className: "text-xs sm:text-sm", children: "Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "email",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "subject", className: "text-xs sm:text-sm", children: "Subject" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "subject",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "message", className: "text-xs sm:text-sm", children: "Message" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Textarea,
                  {
                    id: "message",
...
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent", children: "Irshad" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Full-Stack Developer passionate about creating beautiful and functional web experiences." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => {
                var _a2;
                return (_a2 = document.getElementById("about")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => {
                var _a2;
                return (_a2 = document.getElementById("skills")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
              },
              className: "hover:text-foreground transition-colors",
              children: "Skills"
            }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold mb-4", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: socialLinks.map((social) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" })
            },
            social.label
          );
        }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-8 border-t border-border text-center text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center justify-center gap-1 flex-wrap", children: [
      "© ",
      currentYear,
      " Irshad. Made with",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-4 w-4 text-red-500 fill-red-500 inline" })
    ] }) })
  ] }) }) });
};
const Header = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-14 sm:h-16 md:h-18", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-4 lg:gap-8", children: [
        ...
        isMobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "md:hidden py-4 border-t border-border", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollToSection(item.id),
...
const Hero = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/20 via-background to-accent/20 dark:from-primary/10 dark:via-background dark:to-accent/10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,182,193,0.15),transparent_50%)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 sm:mb-6 inline-block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium border border-primary/20", children: "Welcome to my portfolio" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-foreground via-primary to-accent bg-clip-text text-transparent leading-tight", children: "Hi, I'm Irshad" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl md:text-2xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-4", children: "Full-Stack Developer & Creative Problem Solver" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm sm:text-base md:text-lg text-muted-foreground mb-8 sm:mb-12 max-w-2xl mx-auto px-4", children: "I craft beautiful, functional web experiences that make a difference. Passionate about clean code, innovative solutions, and continuous learning." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "lg",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "h-4 w-4 sm:h-5 sm:w-5 text-muted-foreground" })
            }
          )
        ] }) })
      ]
...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Cross-platform mobile application for tracking workouts, nutrition, and health metrics with social features and personalized recommendations.",
    ...
    },
    {
      ...
      description: "Collection of productivity tools for developers including code snippet manager, API testing interface, and documentation generator.",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-16 sm:py-20 md:py-32 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent", children: "Featured Projects" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto px-4", children: "A selection of my recent work showcasing various technologies and problem-solving approaches" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8", children: projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden aspect-video", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-4 sm:p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg sm:text-xl", children: project.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "line-clamp-3 text-xs sm:text-sm", children: project.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 sm:p-6 pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4", children: project.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: tag }, tag)) }),
                ...
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      rel: "noopener noreferrer",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1.5 sm:mr-2" }),
                        "Demo"
                      ]
                    }
                  )
                ...
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      rel: "noopener noreferrer",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1.5 sm:mr-2" }),
                        "Code"
                      ]
                    }
                  )
...
const Skills = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-16 sm:py-20 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 sm:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent", children: "Skills & Expertise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto px-4", children: "A comprehensive overview of my technical skills and proficiency levels" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-6 sm:gap-8", children: skillCategories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "p-4 sm:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-lg sm:text-xl flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-5 sm:h-6 bg-gradient-to-b from-primary to-accent rounded-full" }),
        category.category
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-5 sm:space-y-6 p-4 sm:p-6 pt-0", children: category.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mb-1.5 sm:mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs sm:text-sm font-medium", children: skill.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs sm:text-sm text-muted-foreground", children: [
            skill.level,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: skill.level, className: "h-1.5 sm:h-2" })
      ] }, skill.name)) })
    ] }, category.category)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 sm:mt-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-4 sm:mb-6 text-sm sm:text-base px-4", children: "Always learning and expanding my skill set. Currently exploring:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2 sm:gap-3 px-4", children: exploringTechs.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(J, { attribute: "class", defaultTheme: "dark", enableSystem: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
...
field ${k} -> ${e.message}`);
  ...
  _buildTypeTableImpl(T) {
    this._fields.forEach(([_2, value]) => value.buildTypeTable(T));
...
class ServiceClass extends ConstructType {
  ...
  _buildTypeTableImpl(T) {
    this._fields.forEach(([_2, func]) => func.buildTypeTable(T));
...
Service({
  ...
  "addSkill": Func([Text, Nat, Nat, ExternalBlob], [], []),
  "getSkillImage": Func([Nat], [Opt(ExternalBlob)], ["query"])
});
